...
PATH_TO_DATASET = os.path.join("C:\\Users\\yozil\\Desktop\\My projects\\",
                               "9.0 End_to_End_House_Price_Prediction\\",
                               "Data\\raw_data\\train.csv")

OUTPUT_SCALER_PATH = os.path.join("C:\\Users\\yozil\\Desktop\\My projects\\",
                                  "9.0 End_to_End_House_Price_Prediction\\",
                                  "deployment_through_procedural_programming\\"
                                  "scaler.pkl")

OUTPUT_MODEL_PATH = os.path.join("C:\\Users\\yozil\\Desktop\\My projects\\",
                                 "9.0 End_to_End_House_Price_Prediction\\",
                                 "deployment_through_procedural_programming\\"
...
ENCODING_MAPPINGS = {'MSZoning': {'Rare': 0, 'RM': 1, 'RH': 2,
                                  'RL': 3, 'FV': 4},
                     'Neighborhood': {'IDOTRR': 0, 'MeadowV': 1, 'BrDale': 2,
                                      'Edwards': 3, 'BrkSide': 4, 'OldTown': 5,
                                      'Sawyer': 6, 'SWISU': 7, 'NAmes': 8,
                                      'Mitchel': 9, 'SawyerW': 10, 'Rare': 11,
                                      'NWAmes': 12, 'Gilbert': 13,
                                      'Blmngtn': 14, 'CollgCr': 15,
                                      'Crawfor': 16, 'ClearCr': 17,
                                      'Somerst': 18, 'Timber': 19,
                                      'StoneBr': 20, 'NridgHt': 21,
                                      'NoRidge': 22},
                     'RoofStyle': {'Gable': 0, 'Rare': 1, 'Hip': 2},
                     'MasVnrType': {'None': 0, 'Rare': 1,
                                    'BrkFace': 2, 'Stone': 3},
                     'BsmtQual': {'Missing': 0, 'Fa': 1, 'TA': 2,
                                  'Gd': 3, 'Ex': 4},
                     'BsmtExposure': {'Missing': 0, 'No': 1, 'Mn': 2,
                                      'Av': 3, 'Gd': 4},
                     'HeatingQC': {'Rare': 0, 'Fa': 1, 'TA': 2,
                                   'Gd': 3, 'Ex': 4},
                     'CentralAir': {'N': 0, 'Y': 1},
                     'KitchenQual': {'Fa': 0, 'TA': 1, 'Gd': 2, 'Ex': 3},
                     'FireplaceQu': {'Po': 0, 'Missing': 1, 'Fa': 2,
                                     'TA': 3, 'Gd': 4, 'Ex': 5},
                     'GarageType': {'Missing': 0, 'Rare': 1, 'Detchd': 2,
                                    'Basment': 3, 'Attchd': 4, 'BuiltIn': 5},
                     'GarageFinish': {'Missing': 0, 'Unf': 1, 'RFn': 2,
                                      'Fin': 3},
